$(function () {
    ...
    $("#sidebar-fold").click(function(e) {
        ...
        if($(this).hasClass("icon-unfold")){
            // fold sidebar
            $(this).removeClass("icon-unfold").addClass("icon-fold").attr("title","Unfold").attr("data-original-title","Unfold");
            ...
            // unfold sidebar
            $(this).removeClass("icon-fold").addClass("icon-unfold").attr("title","Fold").attr("data-original-title","Fold");
