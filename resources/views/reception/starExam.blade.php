...
<div class="questions-content">
    ...
    <div class="question-content" id="5b63cece68d47f53b067312d" data-id="5b63cece68d47f53b067312d" data-commit="true">
        ...
        <div class="question-operation operation-icon icon-mark" data-type="1" data-toggle="tooltip" data-placement="top" data-container="body" title="" data-original-title="标记本题">
        ...
        <div class="exam-question" style="font-size: 16px;">
        ...
        <div class="answers">
            ...
            <div class="select single-select a. " style="font-size: 14px;">
            ...
            <div class="select single-select b. " style="font-size: 14px;">
                <input class="radioOrCheck hidden" data-type="1" id="5b63cece68d47f53b067312d2" name="keyChk_questions_5b63cece68d47f53b067312d" data-name="key2" type="radio">
            ...
            <div class="select single-select c. " style="font-size: 14px;">
    ...
    <div class="question-content" id="5b63cece68d47f53b0673140" data-id="5b63cece68d47f53b0673140" data-commit="true">
        ...
        <div class="exam-question" style="font-size: 16px;">
            ...
            在参加各种社交宴请宾客中,要注意从座椅的（）侧入座,动作应轻而缓,轻松自然。(10.0分)
        </div>
    ...
    <div class="question-content" id="5b63cece68d47f53b0673143" data-id="5b63cece68d47f53b0673143" data-commit="false">
        ...
        <div class="exam-question" style="font-size: 16px;">
            ...
            在机场、商厦、地铁等公共场所乘自动扶梯时应靠（）站立,另一侧供有急事赶路的人快行。(10.0分)
        </div>
...
<div class="nav nav-status">
    <ul class="menu-items">
        <li class="menu-item menu-item-time">
            ...
            <div class="item-data" id="timeDown">00:54:45</div>
        </li>
        <li class="menu-item menu-item-process">
            <div class="item-label">当前进度</div>
            <div class="item-data">
                <span id="commitCount">9</span>/<span id="totalCount">10</span>
            </div>
            <div class="item-process">
                <div class="item-process-bar" id="commitProcess" style="width: 90px;"></div>
            </div>
        </li>
    </ul>
</div>
